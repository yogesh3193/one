...
<body>
    ...
    <section id="about" class="about">
        <h2>About Me</h2>
        <p>Hello! I'm Bharath, a DevOps Engineer passionate about optimizing workflows and delivering scalable, automated solutions. I specialize in tools like Jenkins, Docker, Kubernetes, Terraform, and cloud platforms such as AWS and Azure.</p>
    </section>
